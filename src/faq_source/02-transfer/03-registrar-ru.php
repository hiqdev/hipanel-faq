...
<ol>
    <li>
        <p><b>by registrar: ARDIS-RU</b>, to obtain the auth code you must verify domain`s contact  according to the <?= Html::a('instructions', ['/site/faq#tab-05-verification']) ?>. Next, you need to create a ticket with request for a  auth code.</p>
    </li>
    <li>
