...
<p>
    С целью защитить персональные данные мы предоставляем услугу Whois Protect для всех наших доменных зон. Эта функция скрывает ваши личные данные от всех желающих их посмотреть и на запрос Whois выдает информацию о сервисе Whois Protect.
</p>
<div class="row">
    <div class="col-xs-6">
...
<p>
    Услуга Whois Protect включается автоматически при выполнении регистрации или трансфера домена. Отключить сервис очень просто — достаточно поставить статус "OFF" в поле Whois.
</p>
<p>
    <img src="<?= $options['imgDir'] ?>/help/other/whois/ru/1.jpg">
</p>
